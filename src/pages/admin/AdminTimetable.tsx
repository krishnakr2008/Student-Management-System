  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: Omit<TimetableSlot, 'id'> = {
        ...
        course_name: selectedCourse?.name || editingSlot?.course_name || 'B.Tech CSE',
        ...
        subject_name: selectedSubj?.name || editingSlot?.subject_name || 'Subject',
        subject_code: selectedSubj?.code || editingSlot?.subject_code || 'SUBJ',
        teacher_id: formData.teacher_id,
        teacher_name: selectedTeacher?.profile?.full_name || editingSlot?.teacher_name || 'Faculty Member',
        room: formData.room,
        type: formData.type,
